...
const translations = {
  ru: {
    ...
    calc_season: "Сезон:",
    season_high: "Высокий (май-сентябрь)",
    season_low: "Низкий (октябрь-апрель)",
    calc_rental: "Аренда:",
  ...
  en: {
    ...
    calc_season: "Season:",
    season_high: "High (May-September)",
    season_low: "Low (October-April)",
    calc_rental: "Rental:",
  ...
  bg: {
    ...
    calc_days: "Брой дни:",
    calc_season: "Сезон:",
    season_high: "Висок (май-септември)",
    season_low: "Нисък (октомври-април)",
    calc_rental: "Наем:",
    calc_deposit: "Депозит:",
    calc_total: "Общо:",
    calc_days_text: "дни",
